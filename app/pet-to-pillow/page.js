...
export default function PetToPillowPage() {
  ...
  const pillowSizes = [
    { name: "45 ซม.", value: "45", width: 180, height: 180, price: "500.-" },
    { name: "60 ซม.", value: "60", width: 240, height: 240, price: "700.-" },
    { name: "80 ซม.", value: "80", width: 320, height: 320, price: "1200.-" },
    { name: "100 ซม.", value: "100", width: 400, height: 400, price: "1700.-" },
    { name: "120 ซม.", value: "120", width: 480, height: 480, price: "2290.-" },
    { name: "150 ซม.", value: "150", width: 600, height: 600, price: "2890.-" }
  ];

  // Pillow styles
  const pillowStyles = [
    { name: "คลาสสิก", value: "classic", color: "#f8f9fa", texture: "smooth" },
    { name: "กำมะหยี่", value: "velvet", color: "#6c757d", texture: "rough" },
    { name: "ผ้าฝ้าย", value: "cotton", color: "#ffffff", texture: "soft" },
    { name: "โฟมเมมโมรี่", value: "memory", color: "#e9ecef", texture: "dense" }
  ];
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (result.ok && result.download_url) {
          // ใช้ download_url จาก API response
  ...
  const processImage = async () => {
    ...
    try {
      ...
      if (backgroundOption === 'ai') {
        ...
        const isSubscribed = true; // จำลองว่าสมัครสมาชิกแล้ว
        if (!isSubscribed) {
          alert('ต้องสมัครสมาชิกก่อนเพื่อใช้ฟีเจอร์ AI Background Removal');
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              สร้างหมอนรูปสัตว์เลี้ยงของคุณเอง
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="mt-4 bg-green-50 border border-green-200 rounded-lg p-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="text-sm text-green-800">
                      <strong>พร้อมใช้งาน!</strong> คุณสมัครสมาชิกแล้ว สามารถใช้ AI Background Removal ได้
                    </div>
                  </div>
                </div>
              )}
                  ...
                  {isProcessing ? (
                    <div className="w-full h-80 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center text-gray-500">
                      <div className="text-center">
                        ...
                        <div className="text-lg font-semibold">กำลังประมวลผล...</div>
                        <div className="text-sm">กรุณารอสักครู่</div>
                      </div>
                    </div>
                  ) : createPillowPreview() || (
                    <div className="w-full h-80 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center text-gray-500">
                      <div className="text-center">
                        ...
                        <div>อัปโหลดรูปเพื่อดูตัวอย่าง</div>
                      </div>
                    </div>
                  )}
                </div>
          ...
          <div className="space-y-6">
            ...
            {/* Size Info */}
            <div className="bg-white border-2 border-black rounded-xl p-6">
              <h3 className="text-lg font-bold mb-4">ข้อมูลขนาด</h3>
            ...
            {/* Tips */}
            <div className="bg-white border-2 border-black rounded-xl p-6">
              <h3 className="text-lg font-bold mb-4">💡 เคล็ดลับ</h3>
              
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-2">
                  <div className="text-blue-500">📸</div>
                  <div>ใช้รูปสัตว์เลี้ยงที่ชัดเจน</div>
                </div>
                <div className="flex items-start gap-2">
                  <div className="text-green-500">⚪</div>
                  <div>พื้นหลังขาวจะลบได้ดีที่สุด</div>
                </div>
                <div className="flex items-start gap-2">
                  <div className="text-purple-500">🤖</div>
                  <div>AI จะลบพื้นหลังซับซ้อนได้ดี</div>
                </div>
                <div className="flex items-start gap-2">
                  <div className="text-orange-500">🛏️</div>
                  <div>ขนาดใหญ่จะดูสวยกว่า</div>
                </div>
              </div>
            </div>
          </div>
            ...
            >
              <div className="p-6">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-xl font-bold">รูปบนหมอน</h3>
                  <button
                    onClick={() => setShowPreview(false)}
