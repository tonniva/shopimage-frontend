            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 mb-3">
                    กดปุ่ม "เลือกไฟล์" หรือ "Upload" แล้วเลือกรูปจาก:
                  </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 mb-3">
                    กดปุ่ม <strong>"Convert"</strong> รอสักครู่ (ไม่เกิน 10 วินาที) จากนั้นกด <strong>"Download"</strong> เพื่อบันทึกรูปลงมือถือ
                  </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-lg p-6 border-2 border-blue-400">
              ...
              <div className="mt-4 p-3 bg-blue-50 rounded-lg text-sm text-gray-600">
                <strong>เคล็ดลับ:</strong> เพิ่มเว็บไปหน้าจอหลักเหมือนแอพได้ด้วย "Add to Home Screen"
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 border-2 border-green-400">
              ...
              <div className="mt-4 p-3 bg-green-50 rounded-lg text-sm text-gray-600">
                <strong>เคล็ดลับ:</strong> ใน Chrome กด "เพิ่มที่หน้าจอหลัก" เพื่อเข้าถึงได้ง่าย
              </div>
            </div>
          </div>
        </div>
