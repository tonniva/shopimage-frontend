...
export default function MicaMagneticPhotosPage() {
  ...
  const backgroundTemplates = [
    { id: "fridge1", name: "Refrigerator 1", image: "/bg-slide/ตู้เย็น.jpg" },
    { id: "fridge2", name: "Refrigerator 2", image: "/bg-slide/ตู้เย็น_2.jpg" },
    { id: "fridge3", name: "Refrigerator 3", image: "/bg-slide/ตู้เย็น_3.jpg" }
  ];
  ...
  const proceedToCheckout = async () => {
    ...
    try {
      if (!customerName || !customerEmail) {
        alert('Please fill in name and email before checkout');
        return;
      }

      if (processedImages.length === 0) {
        alert('Please process images before checkout');
        return;
      }
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Create your own mica magnetic photos
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="space-y-4">
                ...
                {uploadedImages.length > 0 && (
                  <div className="space-y-2">
                    <h4 className="font-semibold">Uploaded Images ({uploadedImages.length} images)</h4>
                        ...
                        <div key={image.id} className="flex items-center gap-2 p-2 bg-gray-50 rounded-lg">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-gray-500">
                              {image.processed ? '✅ Processed' : '⏳ Waiting'}
                            </p>
                          </div>
                          <button
              ...
              <div className="bg-white border-2 border-black rounded-xl p-6">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold">{processedImages.length} images</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="border-t pt-2">
                    <div className="flex justify-between text-lg font-bold">
                      <span>Total:</span>
                      <span className="text-purple-600">{calculateTotalPrice()} Baht</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="lg:col-span-6 space-y-6 lg:sticky lg:top-24 lg:self-start">
            ...
            <div className="bg-white border-2 border-black rounded-xl p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold">Preview on Fridge</h3>
                <button
                ...
                >
                  {isShowingAll ? 'Hide Images' : 'Show All'}
                </button>
              </div>
              ...
              {isProcessing ? (
                ...
                <div className="relative space-y-3">
                  ...
                  <div className="flex items-center gap-3 bg-white p-3 rounded-lg border-2 border-gray-300">
                    <span className="text-sm font-semibold text-gray-700 whitespace-nowrap">Size:</span>
                    <input
                      type="range"
                      min="20"
                      max="150"
                    ...
                    {!isShowingAll ? (
                      <div className="absolute inset-0 flex items-center justify-center text-center text-white bg-black bg-opacity-30">
                        <div>
                          ...
                          <p className="font-semibold">Click &quot;Show All&quot; to display images</p>
                          <p className="text-sm mt-1">Drag images to arrange on fridge</p>
                        </div>
                      </div>
                    ) : (
                      <>
                        ...
                        <div className="absolute bottom-2 left-2 bg-black bg-opacity-70 text-white px-3 py-1.5 rounded-lg text-sm font-semibold">
                          {processedImages.length} images - Drag to move
                        </div>
                      </>
                    )}
                  </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            {processedImages.length > 0 && (
              <div className="bg-white border-2 border-black rounded-xl p-6">
                <h3 className="text-xl font-bold mb-4">Free Download</h3>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-4 rounded-lg border-2 border-purple-200">
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-bold text-purple-600">{processedImages.length} images</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="font-semibold">Price per image:</span>
                        <span className="font-bold">{sizeTemplates.find(t => t.id === selectedSize)?.price}</span>
                      </div>
                      <div className="border-t border-purple-200 pt-2 mt-2">
                        <div className="flex justify-between text-lg">
                          <span className="font-bold">Total:</span>
                          <span className="font-bold text-purple-600">{calculateTotalPrice()} ฿</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <p className="text-xs text-gray-500 text-center">
                    💡 Or download for free above (no physical Mica)
                  </p>
                </div>
              </div>
            )}
            ...
            {/* Image List Summary */}
            <div className="bg-white border-2 border-black rounded-xl p-6">
              <h3 className="text-xl font-bold mb-4">Image List</h3>
