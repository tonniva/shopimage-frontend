    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="mb-6">
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-4 py-2 border-2 border-black rounded-lg bg-white hover:bg-gray-50 hover:-translate-y-0.5 hover:shadow-[4px_4px_0_#000] active:translate-y-0 active:shadow-[2px_2px_0_#000] transition-all duration-150"
          >
            <ArrowLeft size={18} />
        ...
        <div className="border-2 border-black bg-white rounded-2xl shadow-[8px_8px_0_#000] p-8">
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-gray-500">
              ...
              <a href="#" className="underline hover:text-gray-700">เงื่อนไขการใช้งาน</a>
            </p>
